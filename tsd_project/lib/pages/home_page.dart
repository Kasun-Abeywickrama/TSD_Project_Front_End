...
class HomePage extends StatefulWidget {
  ...
  //Navigating function to go to previous result page
  final Function() navigateToPreviousResults;

  //When a new unique key is passed, the widget page will rebuild including the initial process method
  const HomePage({Key? key, required this.navigateToPreviousResults}) : super(key: key);
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            widget.navigateToPreviousResults();
                                          },
                                          child: Text(
                                            'View results',
                                            style: GoogleFonts.lato(
