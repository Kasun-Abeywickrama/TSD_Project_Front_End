                                      ...
                                      child: MaterialButton(
                                        onPressed: () {
                                          ...
                                          Map<String, dynamic> appointmentDetailsMap = {
                                            'appointment_id': appointmentList[i].appointmentId,
                                            'counselor_first_name': appointmentList[i].counselorFirstName,
                                            'counselor_last_name': appointmentList[i].counselorLastName,
                                          ...
                                          Navigator.push(
                                              ...
                                              (MaterialPageRoute(
                                                  builder: (context) =>
                                                      AppointmentDetailsPage(appointmentDetails: appointmentDetailsMap,))));
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          child: Text(
                                                            appointmentList[i].appointmentDate,
                                                            style: const TextStyle(
                                                              fontSize: 16,
                                                              fontWeight: FontWeight.bold,
                                                              color: Color.fromRGBO(
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          child: Text(
                                                            appointmentList[i].appointmentTime,
                                                            style: const TextStyle(
                                                              fontSize: 16,
                                                              fontWeight: FontWeight.bold,
                                                              color: Color.fromRGBO(
