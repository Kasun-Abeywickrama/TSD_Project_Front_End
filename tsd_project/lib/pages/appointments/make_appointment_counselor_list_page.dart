...
import 'package:tsd_project/pages/appointments/make_appointment_page.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;
import '../../decoration_tools/custom_loading_indicator.dart';
import '../../important_tools/user_authentication.dart';

class MakeAppointmentCounselorListPage extends StatefulWidget {
  ...
  MakeAppointmentCounselorListPage({required this.quizResultId});

  @override
  State<MakeAppointmentCounselorListPage> createState() =>
      _MakeAppointmentCounselorListPageState();
}

class _MakeAppointmentCounselorListPageState
    extends State<MakeAppointmentCounselorListPage> {
    ...
    if (context.mounted) {
      if (await checkLoginStatus(context)) {
        try {
          ...
          String apiUrl = (await ReadApiEndpoints.readApiEndpointsData())["requestCounselorDetailsEndpoint"];
