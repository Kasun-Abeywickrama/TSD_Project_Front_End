...
class MakeAppointmentPage extends StatefulWidget {
  ...
  MakeAppointmentPage(
      {super.key, required this.quizResultId, required this.counselorDetails});
...
class _MakeAppointmentPageState extends State<MakeAppointmentPage> {
                ...
                child: ListView(children: [
                  Column(
                    children: [
                      ...
                      const SizedBox(
                          height: 10), // Adding space between text and image
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            padding:
                                const EdgeInsets.fromLTRB(20.0, 20, 20, 30),
                            child: Column(
  ...
  void appointmentSuccessDialog() {
    QuickAlert.show(
      ...
      text:
          'Please wait patiently. A mail will be received from the counselor within several days',
    );
  }
